// This file is a duplicate of getQuestions/data.ts.
// The PDF Lambda needs all answer options to render radio-button-style lists.
// IMPORTANT: Must stay in sync with infrastructure/lambda/getQuestions/data.ts
